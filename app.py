...
kmbert_model.load_state_dict(torch.load("checkpoint/model_filekmbert_finetuned_model.pt", map_location='cpu'))
kmbert_model.eval()

stack_model_1 = joblib.load("checkpoint/model_filestack_model_1.pkl")           # 1차 분류 스택 모델
stack_model_2 = joblib.load("checkpoint/model_filestack_model_2.pkl")           # 2차 분류 모델
xgb_model = joblib.load("checkpoint/model_filexgb_model_for_1st_stage.pkl")     # 1차 분류용 XGBoost 모델

label_encoder_diagnosis = joblib.load("checkpoint/model_filelabel_encoder_diagnosis.pkl")
label_encoder_code = joblib.load("checkpoint/model_filelabel_encoder_code.pkl")
one_hot_encoder = joblib.load("checkpoint/model_fileonehot_encoder.pkl")
scaler = joblib.load("checkpoint/model_filescaler.pkl")
